...
- ☕ Java developer, currently diving deeper into Spring Boot and backend architecture
...
- **Build & Automation**: CMake , Maven
- **Frontend**: Tailwind CSS , React.js , Ant Design 
- **Backend**: Node.js, Express.js, Redis , MySQL
